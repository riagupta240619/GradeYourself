            ...
            <Card key={comp.id} className="border border-slate-200 bg-white/90 dark:border-white/10 dark:bg-zinc-900/90 overflow-hidden shadow-lg">
              ...
              <CardContent className="p-0 overflow-x-auto min-w-full">
                <table className="w-full min-w-[500px] text-xs text-left">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-zinc-950 text-slate-700 dark:text-zinc-300 font-bold uppercase tracking-wider text-[11px]">
                        ...
                        <tr key={ast.id} className="hover:bg-purple-50/50 dark:hover:bg-purple-500/10 transition-colors">
                          ...
                          <td className="px-6 py-3.5">
                            <div className="flex items-center gap-2.5">
                              <input
                                type="number"
                                className="w-28 rounded-lg border border-slate-200 bg-white dark:border-white/10 dark:bg-zinc-950 px-3 py-1.5 font-mono text-sm font-bold text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-zinc-500 focus:border-purple-600 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all"
                                placeholder="—"
                                value={raw ?? ""}
                                max={ast.maxMarks}
