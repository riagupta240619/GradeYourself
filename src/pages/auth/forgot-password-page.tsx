        ...
        {!sent ? (
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="py-4">
            ...
            <p className="mt-2 text-xs text-slate-500 dark:text-zinc-400 leading-relaxed">
              We've sent a password reset link to <span className="font-semibold text-slate-900 dark:text-white">{email}</span>. Please follow the instructions in the email.
            </p>
          </motion.div>
        )}

        <div className="mt-6 border-t border-slate-200 dark:border-white/10 pt-4 text-xs">
          <Link to="/login" className="inline-flex items-center gap-1.5 font-semibold text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition-colors">
