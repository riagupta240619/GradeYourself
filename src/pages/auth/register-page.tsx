...
import { GraduationCap, Sparkles, CheckCircle2, Lock, Mail, User, ArrowRight, Sun, Moon } from "lucide-react";
    ...
    <div className="relative flex min-h-screen w-full bg-slate-50 text-slate-900 dark:bg-[#09090b] dark:text-white overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 relative border-r border-slate-200 bg-white/80 dark:border-white/10 dark:bg-zinc-950/80">
        ...
        <div className="relative z-10 my-auto max-w-md">
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-300 bg-purple-50 dark:border-purple-500/30 dark:bg-purple-500/10 px-3.5 py-1 text-xs font-medium text-purple-700 dark:text-purple-300 mb-4">
        ...
        <div className="relative z-10 text-xs text-slate-400 dark:text-zinc-500">
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12 relative">
        ...
        >
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <label className="flex items-start gap-2.5 text-xs text-slate-600 dark:text-zinc-400 mt-1 cursor-pointer">
              <input type="checkbox" required className="mt-0.5 rounded border-slate-300 dark:border-white/10 accent-purple-600" />
