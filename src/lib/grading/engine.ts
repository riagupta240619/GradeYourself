...
/** Confidence-ranged prediction for where a subject will land, per Phase 5 §8. */
...
/** Cumulative CGPA across all provided semesters (past finalized + current in-progress). */
